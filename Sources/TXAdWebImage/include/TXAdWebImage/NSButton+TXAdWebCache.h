...
/**
 * Integrates TXAdWebImage async downloading and caching of remote images with NSButton.
 */
 ...
 */
- (void)txad_setImageWithURL:(nullable NSURL *)url NS_REFINED_FOR_SWIFT;
 ...
 */
@property (nonatomic, strong, readonly, nullable) NSURL *txad_currentAlternateImageURL;
 ...
 */
- (void)txad_setAlternateImageWithURL:(nullable NSURL *)url NS_REFINED_FOR_SWIFT;
 ...
 * @see txad_setAlternateImageWithURL:placeholderImage:options:
 */
 ...
 * @param url         The url for the alternateImage.
 * @param placeholder The alternateImage to be set initially, until the alternateImage request finishes.
 * @param options     The options to use when downloading the alternateImage. @see TXAdWebImageOptions for the possible values.
 */
- (void)txad_setAlternateImageWithURL:(nullable NSURL *)url
                   placeholderImage:(nullable UIImage *)placeholder
                            options:(TXAdWebImageOptions)options NS_REFINED_FOR_SWIFT;
