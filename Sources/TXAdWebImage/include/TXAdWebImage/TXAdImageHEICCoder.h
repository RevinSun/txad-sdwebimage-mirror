...
/**
 ...
 @note If you need to support lower firmware version for HEIF, you can have a try at https://github.com/TXAdWebImage/TXAdWebImageHEIFCoder
 */
API_AVAILABLE(ios(13.0), tvos(13.0), macos(10.15), watchos(6.0))
@interface TXAdImageHEICCoder : TXAdImageIOAnimatedCoder <TXAdProgressiveImageCoder, TXAdAnimatedImageCoder>

@property (nonatomic, class, readonly, nonnull) TXAdImageHEICCoder *sharedCoder;
