...
/**
 This class is used for creating animated images via `animatedImageWithFrames` in `TXAdImageCoderHelper`.
 @note If you need to specify animated images loop count, use `txad_imageLoopCount` property in `UIImage+Metadata.h`.
 */
@interface TXAdImageFrame : NSObject
