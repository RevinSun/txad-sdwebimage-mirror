...
typedef NSURLResponse * _Nullable (^TXAdWebImageDownloaderResponseModifierBlock)(NSURLResponse * _Nonnull response);
 ...
 */
@protocol TXAdWebImageDownloaderResponseModifier <NSObject>
...
/// @note If nil is returned, the image download will marked as cancelled with error `TXAdWebImageErrorInvalidDownloadResponse`
 ...
 */
@interface TXAdWebImageDownloaderResponseModifier : NSObject <TXAdWebImageDownloaderResponseModifier>

/// Create the response modifier with block
/// @param block A block to control modifier logic
- (nonnull instancetype)initWithBlock:(nonnull TXAdWebImageDownloaderResponseModifierBlock)block;

/// Create the response modifier with block
/// @param block A block to control modifier logic
+ (nonnull instancetype)responseModifierWithBlock:(nonnull TXAdWebImageDownloaderResponseModifierBlock)block;
...
*/
@interface TXAdWebImageDownloaderResponseModifier (Conveniences)
