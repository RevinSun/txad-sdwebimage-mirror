...
#import <TXAdWebImage/UIImageView+TXAdWebCache.h>
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    // Here we use the provided txad_setImageWithURL:placeholderImage: method to load the web image
    // Ensure you use a placeholder image otherwise cells will be initialized with no image
    [cell.imageView txad_setImageWithURL:[NSURL URLWithString:@"http://example.com/image.jpg"]
...
/**
 * Integrates TXAdWebImage async downloading and caching of remote images with UIImageView.
 */
 ...
 * @note For highlighted image, use `txad_cancelCurrentHighlightedImageLoad`
 */
