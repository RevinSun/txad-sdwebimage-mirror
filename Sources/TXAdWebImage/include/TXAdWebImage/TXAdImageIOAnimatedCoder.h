 ...
 */
@interface TXAdImageIOAnimatedCoder : NSObject <TXAdProgressiveImageCoder, TXAdAnimatedImageCoder>

#pragma mark - Subclass Override
/**
 The supported animated image format. Such as `TXAdImageFormatGIF`.
 @note Subclass override.
 */
@property (class, readonly) TXAdImageFormat imageFormat;
/**
 The supported image format UTI Type. Such as `kTXAdUTTypeGIF`.
 This can be used for cases when we can not detect `TXAdImageFormat. Such as progressive decoding's hint format `kCGImageSourceTypeIdentifierHint`.
 @note Subclass override.
 */
