...
/**
 ...
 @note For coder plugin developer, always use the TXAdImageCoderHelper's `colorSpaceGetDeviceRGB`/`preferredPixelFormat` to create CGImage.
 @note For more information why force decode, see: https://github.com/path/FastImageCache#byte-alignment
 @note From v5.17.0, the default value is always NO. Use `TXAdImageForceDecodePolicy` to control complicated policy.
 */
@property (nonatomic, assign) BOOL txad_isDecoded;
