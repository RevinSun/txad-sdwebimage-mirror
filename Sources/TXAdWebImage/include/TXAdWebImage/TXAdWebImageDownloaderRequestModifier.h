...
typedef NSURLRequest * _Nullable (^TXAdWebImageDownloaderRequestModifierBlock)(NSURLRequest * _Nonnull request);
 ...
 */
@protocol TXAdWebImageDownloaderRequestModifier <NSObject>
 ...
 */
@interface TXAdWebImageDownloaderRequestModifier : NSObject <TXAdWebImageDownloaderRequestModifier>

/// Create the request modifier with block
/// @param block A block to control modifier logic
- (nonnull instancetype)initWithBlock:(nonnull TXAdWebImageDownloaderRequestModifierBlock)block;

/// Create the request modifier with block
/// @param block A block to control modifier logic
+ (nonnull instancetype)requestModifierWithBlock:(nonnull TXAdWebImageDownloaderRequestModifierBlock)block;
...
*/
@interface TXAdWebImageDownloaderRequestModifier (Conveniences)
