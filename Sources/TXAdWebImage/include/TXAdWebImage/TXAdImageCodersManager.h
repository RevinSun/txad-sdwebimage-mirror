...
/**
 ...
 Coders
 ------
 A coder must conform to the `TXAdImageCoder` protocol or even to `TXAdProgressiveImageCoder` if it supports progressive decoding
 ...
 */
@interface TXAdImageCodersManager : NSObject <TXAdImageCoder>

/**
 Returns the global shared coders manager instance.
 */
@property (nonatomic, class, readonly, nonnull) TXAdImageCodersManager *sharedManager;
 ...
 */
@property (nonatomic, copy, nullable) NSArray<id<TXAdImageCoder>> *coders;
