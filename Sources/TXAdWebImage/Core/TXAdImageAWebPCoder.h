...
/**
 ...
 @note If you need to support lower firmware version for WebP, you can have a try at https://github.com/TXAdWebImage/TXAdWebImageWebPCoder
 */
API_AVAILABLE(ios(14.0), tvos(14.0), macos(11.0), watchos(7.0))
@interface TXAdImageAWebPCoder : TXAdImageIOAnimatedCoder <TXAdProgressiveImageCoder, TXAdAnimatedImageCoder>

@property (nonatomic, class, readonly, nonnull) TXAdImageAWebPCoder *sharedCoder;
