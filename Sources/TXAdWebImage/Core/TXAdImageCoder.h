...
typedef NSString * TXAdImageCoderOption NS_STRING_ENUM;
typedef NSDictionary<TXAdImageCoderOption, id> TXAdImageCoderOptions;
typedef NSMutableDictionary<TXAdImageCoderOption, id> TXAdImageCoderMutableOptions;
...
/**
 ...
 @note works for `TXAdImageCoder`.
 */
FOUNDATION_EXPORT TXAdImageCoderOption _Nonnull const TXAdImageCoderDecodeFirstFrameOnly;
...
/**
 ...
 @note works for `TXAdImageCoder`, `TXAdProgressiveImageCoder`, `TXAdAnimatedImageCoder`.
 */
FOUNDATION_EXPORT TXAdImageCoderOption _Nonnull const TXAdImageCoderDecodeScaleFactor;
...
/**
 ...
 @note works for `TXAdImageCoder`, `TXAdProgressiveImageCoder`, `TXAdAnimatedImageCoder`.
 */
FOUNDATION_EXPORT TXAdImageCoderOption _Nonnull const TXAdImageCoderDecodePreserveAspectRatio;
...
/**
 ...
 @note works for `TXAdImageCoder`, `TXAdProgressiveImageCoder`, `TXAdAnimatedImageCoder`.
 */
FOUNDATION_EXPORT TXAdImageCoderOption _Nonnull const TXAdImageCoderDecodeThumbnailPixelSize;
 ...
 */
FOUNDATION_EXPORT TXAdImageCoderOption _Nonnull const TXAdImageCoderDecodeFileExtensionHint;
 ...
 */
FOUNDATION_EXPORT TXAdImageCoderOption _Nonnull const TXAdImageCoderDecodeTypeIdentifierHint;
...
/**
 ...
 @note works for `TXAdImageCoder`, `TXAdProgressiveImageCoder`, `TXAdAnimatedImageCoder`.
 */
FOUNDATION_EXPORT TXAdImageCoderOption _Nonnull const TXAdImageCoderDecodeUseLazyDecoding;
...
/**
 ...
 @note You can use the logic from `+[TXAdImageCoder scaledSizeWithImageSize:limitBytes:bytesPerPixel:frameCount:]`
 @note This option has higher priority than `.decodeThumbnailPixelSize`
 */
FOUNDATION_EXPORT TXAdImageCoderOption _Nonnull const TXAdImageCoderDecodeScaleDownLimitBytes;
...
/**
 ...
 @note works for `TXAdImageCoder`.
 */
FOUNDATION_EXPORT TXAdImageCoderOption _Nonnull const TXAdImageCoderEncodeFirstFrameOnly;
/**
 ...
 @note works for `TXAdImageCoder`
 */
FOUNDATION_EXPORT TXAdImageCoderOption _Nonnull const TXAdImageCoderEncodeCompressionQuality;
...
/**
 ...
 @note works for `TXAdImageCoder`
 */
FOUNDATION_EXPORT TXAdImageCoderOption _Nonnull const TXAdImageCoderEncodeBackgroundColor;
...
/**
 ...
 @note works for `TXAdImageCoder`
 */
FOUNDATION_EXPORT TXAdImageCoderOption _Nonnull const TXAdImageCoderEncodeMaxFileSize;
...
/**
 ...
 @note works for `TXAdImageCoder`
 */
FOUNDATION_EXPORT TXAdImageCoderOption _Nonnull const TXAdImageCoderEncodeEmbedThumbnail;

/**
 A TXAdWebImageContext object which hold the original context options from top-level API. (TXAdWebImageContext)
 ...
 Only the unknown context from top-level API (See TXAdWebImageDefine.h) may be passed in during image loading.
 See `TXAdWebImageContext` for more detailed information.
 @warning Deprecated. This does nothing from 5.14.0. Use `TXAdWebImageContextImageDecodeOptions` to pass additional information in top-level API, and use `TXAdImageCoderOptions` to retrieve options from coder.
 */
FOUNDATION_EXPORT TXAdImageCoderOption _Nonnull const TXAdImageCoderWebImageContext API_DEPRECATED("No longer supported. Use TXAdWebImageContextDecodeOptions in loader API to provide options. Use TXAdImageCoderOptions in coder API to retrieve options.", macos(10.10, 10.10), ios(8.0, 8.0), tvos(9.0, 9.0), watchos(2.0, 2.0));
 ...
 */
@protocol TXAdImageCoder <NSObject>
...
/**
 ...
 @note This protocol may supports decode animated image frames. You can use `+[TXAdImageCoderHelper animatedImageWithFrames:]` to produce an animated image with frames.

 @param data The image data to be decoded
 @param options A dictionary containing any decoding options. Pass @{TXAdImageCoderDecodeScaleFactor: @(1.0)} to specify scale factor for image. Pass @{TXAdImageCoderDecodeFirstFrameOnly: @(YES)} to decode the first frame only.
 @return The decoded image from data
 */
- (nullable UIImage *)decodedImageWithData:(nullable NSData *)data
                                   options:(nullable TXAdImageCoderOptions *)options;

#pragma mark - Encoding

/**
 Returns YES if this coder can encode some image. Otherwise, it should be passed to another coder.
 For custom coder which introduce new image format, you'd better define a new `TXAdImageFormat` using like this. If you're creating public coder plugin for new image format, also update `https://github.com/rs/TXAdWebImage/wiki/Coder-Plugin-List` to avoid same value been defined twice.
 * @code
 static const TXAdImageFormat TXAdImageFormatHEIF = 10;
 * @endcode
 
 @param format The image format
 @return YES if this coder can encode the image, NO otherwise
 */
- (BOOL)canEncodeToFormat:(TXAdImageFormat)format NS_SWIFT_NAME(canEncode(to:));

/**
 Encode the image to image data.
 @note This protocol may supports encode animated image frames. You can use `+[TXAdImageCoderHelper framesFromAnimatedImage:]` to assemble an animated image with frames. But this consume time is not always reversible. In 5.15.0, we introduce `encodedDataWithFrames` API for better animated image encoding. Use that instead.
 @note Which means, this just forward to `encodedDataWithFrames([TXAdImageFrame(image: image, duration: 0], image.txad_imageLoopCount))`

 @param image The image to be encoded
 @param format The image format to encode, you should note `TXAdImageFormatUndefined` format is also  possible
 @param options A dictionary containing any encoding options. Pass @{TXAdImageCoderEncodeCompressionQuality: @(1)} to specify compression quality.
 @return The encoded image data
 */
- (nullable NSData *)encodedDataWithImage:(nullable UIImage *)image
                                   format:(TXAdImageFormat)format
                                  options:(nullable TXAdImageCoderOptions *)options;
...
/**
 ...
 @param loopCount The final animated image loop count. 0 means infinity loop. This config ignore each frame's `txad_imageLoopCount`
 @param format The image format to encode, you should note `TXAdImageFormatUndefined` format is also  possible
 @param options A dictionary containing any encoding options. Pass @{TXAdImageCoderEncodeCompressionQuality: @(1)} to specify compression quality.
 @return The encoded image data
 */
- (nullable NSData *)encodedDataWithFrames:(nonnull NSArray<TXAdImageFrame *>*)frames
...
/**
 ...
 @note Pay attention that these methods are not called from main queue.
 */
@protocol TXAdProgressiveImageCoder <TXAdImageCoder>
...
/**
 ...
 @param options A dictionary containing any progressive decoding options (instance-level). Pass @{TXAdImageCoderDecodeScaleFactor: @(1.0)} to specify scale factor for progressive animated image (each frames should use the same scale).
 @return A new instance to do incremental decoding for the specify image format
 */
- (nonnull instancetype)initIncrementalWithOptions:(nullable TXAdImageCoderOptions *)options;
...
/**
 ...
 @note Due to the performance issue for progressive decoding and the integration for image view. This method may only return the first frame image even if the image data is animated image. If you want progressive animated image decoding, conform to `TXAdAnimatedImageCoder` protocol as well and use `animatedImageFrameAtIndex:` instead.

 @param options A dictionary containing any progressive decoding options. Pass @{TXAdImageCoderDecodeScaleFactor: @(1.0)} to specify scale factor for progressive image
 @return The decoded image from current data
 */
- (nullable UIImage *)incrementalDecodedImageWithOptions:(nullable TXAdImageCoderOptions *)options;

@end

#pragma mark - Animated Image Provider
/**
 This is the animated image protocol to provide the basic function for animated image rendering. It's adopted by `TXAdAnimatedImage` and `TXAdAnimatedImageCoder`
 */
@protocol TXAdAnimatedImageProvider <NSObject>
...
/**
 This is the animated image coder protocol for custom animated image class like  `TXAdAnimatedImage`. Through it inherit from `TXAdImageCoder`. We currentlly only use the method `canDecodeFromData:` to detect the proper coder for specify animated image format.
 */
@protocol TXAdAnimatedImageCoder <TXAdImageCoder, TXAdAnimatedImageProvider>
...
/**
 ...
 After the instance created, we may call methods in `TXAdAnimatedImageProvider` to produce animated image frame.

 @param data The animated image data to be decode
 @param options A dictionary containing any animated decoding options (instance-level). Pass @{TXAdImageCoderDecodeScaleFactor: @(1.0)} to specify scale factor for animated image (each frames should use the same scale).
 @return A new instance to do animated decoding for specify image data
 */
- (nullable instancetype)initWithAnimatedImageData:(nullable NSData *)data options:(nullable TXAdImageCoderOptions *)options;
