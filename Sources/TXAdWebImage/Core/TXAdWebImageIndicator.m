...
@interface TXAdWebImageActivityIndicator ()
...
@implementation TXAdWebImageActivityIndicator
...
@implementation TXAdWebImageActivityIndicator (Conveniences)

#if !TXAd_VISION
#pragma clang diagnostic push
#pragma clang diagnostic ignored "-Wdeprecated-declarations"
+ (TXAdWebImageActivityIndicator *)grayIndicator {
    TXAdWebImageActivityIndicator *indicator = [TXAdWebImageActivityIndicator new];
#if TXAd_UIKIT
#if TXAd_IOS
...
+ (TXAdWebImageActivityIndicator *)grayLargeIndicator {
    TXAdWebImageActivityIndicator *indicator = TXAdWebImageActivityIndicator.grayIndicator;
#if TXAd_UIKIT
...
+ (TXAdWebImageActivityIndicator *)whiteIndicator {
    TXAdWebImageActivityIndicator *indicator = [TXAdWebImageActivityIndicator new];
#if TXAd_UIKIT
...
+ (TXAdWebImageActivityIndicator *)whiteLargeIndicator {
    TXAdWebImageActivityIndicator *indicator = TXAdWebImageActivityIndicator.whiteIndicator;
#if TXAd_UIKIT
    indicator.indicatorView.activityIndicatorViewStyle = UIActivityIndicatorViewStyleWhiteLarge;
#else
    indicator.indicatorView.appearance = [NSAppearance appearanceNamed:NSAppearanceNameAqua]; // Disable dark mode support
...
+ (TXAdWebImageActivityIndicator *)largeIndicator {
    TXAdWebImageActivityIndicator *indicator = [TXAdWebImageActivityIndicator new];
#if TXAd_VISION
...
+ (TXAdWebImageActivityIndicator *)mediumIndicator {
    TXAdWebImageActivityIndicator *indicator = [TXAdWebImageActivityIndicator new];
#if TXAd_VISION
...
@interface TXAdWebImageProgressIndicator ()
...
@implementation TXAdWebImageProgressIndicator
...
@implementation TXAdWebImageProgressIndicator (Conveniences)

+ (TXAdWebImageProgressIndicator *)defaultIndicator {
    TXAdWebImageProgressIndicator *indicator = [TXAdWebImageProgressIndicator new];
    return indicator;
}

#if TXAd_UIKIT
+ (TXAdWebImageProgressIndicator *)barIndicator API_UNAVAILABLE(tvos) {
    TXAdWebImageProgressIndicator *indicator = [TXAdWebImageProgressIndicator new];
