...
/**
 ...
 @note If the receiver is `TXAdAnimatedImage`, this will return the animated image data if available. No more extra encoding process.
 @note For macOS, if the receiver contains only `TXAdAnimatedImageRep`, this will return the animated image data if available. No more extra encoding process.
...
/**
 ...
 @return The encoded data. If can't encode, return nil
 */
- (nullable NSData *)txad_imageDataAsFormat:(TXAdImageFormat)imageFormat NS_SWIFT_NAME(txad_imageData(as:));
...
/**
 ...
 @return The encoded data. If can't encode, return nil
 */
- (nullable NSData *)txad_imageDataAsFormat:(TXAdImageFormat)imageFormat compressionQuality:(double)compressionQuality NS_SWIFT_NAME(txad_imageData(as:compressionQuality:));
...
/**
 ...
 @return The encoded data. If can't encode, return nil
 */
- (nullable NSData *)txad_imageDataAsFormat:(TXAdImageFormat)imageFormat compressionQuality:(double)compressionQuality firstFrameOnly:(BOOL)firstFrameOnly NS_SWIFT_NAME(txad_imageData(as:compressionQuality:firstFrameOnly:));
