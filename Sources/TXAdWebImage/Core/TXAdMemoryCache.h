...
@class TXAdImageCacheConfig;
/**
 A protocol to allow custom memory cache used in TXAdImageCache.
 */
@protocol TXAdMemoryCache <NSObject>
 ...
 */
- (nonnull instancetype)initWithConfig:(nonnull TXAdImageCacheConfig *)config;
 ...
 */
@interface TXAdMemoryCache <KeyType, ObjectType> : NSCache <KeyType, ObjectType> <TXAdMemoryCache>

@property (nonatomic, strong, nonnull, readonly) TXAdImageCacheConfig *config;
