...
/**
 ...
 For a full GIF support, we recommend `TXAdAnimatedImageView` to keep both CPU and memory balanced.
 ...
 */
@interface TXAdImageIOCoder : NSObject <TXAdProgressiveImageCoder>

@property (nonatomic, class, readonly, nonnull) TXAdImageIOCoder *sharedCoder;
