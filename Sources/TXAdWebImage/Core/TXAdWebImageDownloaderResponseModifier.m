...
@interface TXAdWebImageDownloaderResponseModifier ()

@property (nonatomic, copy, nonnull) TXAdWebImageDownloaderResponseModifierBlock block;

@end

@implementation TXAdWebImageDownloaderResponseModifier

- (instancetype)initWithBlock:(TXAdWebImageDownloaderResponseModifierBlock)block {
    self = [super init];
    if (self) {
        self.block = block;
    }
...
+ (instancetype)responseModifierWithBlock:(TXAdWebImageDownloaderResponseModifierBlock)block {
    TXAdWebImageDownloaderResponseModifier *responseModifier = [[TXAdWebImageDownloaderResponseModifier alloc] initWithBlock:block];
...
@implementation TXAdWebImageDownloaderResponseModifier (Conveniences)
