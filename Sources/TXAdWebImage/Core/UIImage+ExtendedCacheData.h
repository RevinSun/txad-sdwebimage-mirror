...
/**
 ...
 @note The disk cache preserve both of the data and extended data with the same cache key. For manual query, use the `TXAdDiskCache` protocol method `extendedDataForKey:` instead.
 ...
 */
@property (nonatomic, strong, nullable) id<NSObject, NSCoding> txad_extendedObject;
