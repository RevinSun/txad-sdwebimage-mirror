...
/**
 A protocol to allow custom disk cache used in TXAdImageCache.
 */
@protocol TXAdDiskCache <NSObject>
 ...
 */
- (nullable instancetype)initWithCachePath:(nonnull NSString *)cachePath config:(nonnull TXAdImageCacheConfig *)config;
 ...
 */
@interface TXAdDiskCache : NSObject <TXAdDiskCache>
/**
 Cache Config object - storing all kind of settings.
 */
@property (nonatomic, strong, readonly, nonnull) TXAdImageCacheConfig *config;
