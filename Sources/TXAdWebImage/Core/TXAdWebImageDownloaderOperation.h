...
/**
 ...
 For the description about these methods, see `TXAdWebImageDownloaderOperation`
 ...
 */
@protocol TXAdWebImageDownloaderOperation <NSURLSessionTaskDelegate, NSURLSessionDataDelegate>
@required
...
// These operation-level config was inherited from downloader. See `TXAdWebImageDownloaderConfig` for documentation.
...
/**
 The download operation class for TXAdWebImageDownloader.
 */
@interface TXAdWebImageDownloaderOperation : NSOperation <TXAdWebImageDownloaderOperation>
 ...
 */
@property (assign, nonatomic, readonly) TXAdWebImageDownloaderOptions options;

/**
 * The context for the receiver.
 */
@property (copy, nonatomic, readonly, nullable) TXAdWebImageContext *context;

/**
 *  Initializes a `TXAdWebImageDownloaderOperation` object
 *
 *  @see TXAdWebImageDownloaderOperation
 *
...
- (nonnull instancetype)initWithRequest:(nullable NSURLRequest *)request
                              inSession:(nullable NSURLSession *)session
                                options:(TXAdWebImageDownloaderOptions)options
                                context:(nullable TXAdWebImageContext *)context NS_DESIGNATED_INITIALIZER;
