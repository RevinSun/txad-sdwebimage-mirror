 ...
 */
FOUNDATION_EXPORT NSString * _Nullable TXAdTransformedKeyForKey(NSString * _Nullable key, NSString * _Nonnull transformerKey);
...
/**
 ...
 @note If you have both transformer and thumbnail applied for image, call `TXAdThumbnailedKeyForKey` firstly and then with `TXAdTransformedKeyForKey`.`
 */
FOUNDATION_EXPORT NSString * _Nullable TXAdThumbnailedKeyForKey(NSString * _Nullable key, CGSize thumbnailPixelSize, BOOL preserveAspectRatio);

/**
 A transformer protocol to transform the image load from cache or from download.
 You can provide transformer to cache and manager (Through the `transformer` property or context option `TXAdWebImageContextImageTransformer`).
 
 @note The transform process is called from a global queue in order to not to block the main queue.
 */
@protocol TXAdImageTransformer <NSObject>

@optional

/**
 Defaults to YES.
 We keep some metadata like Image Format (`txad_imageFormat`)/ Animated Loop Count (`txad_imageLoopCount`) via associated object on UIImage instance.
 ...
 */
@interface TXAdImagePipelineTransformer : NSObject <TXAdImageTransformer>

/**
 All transformers in pipeline
 */
@property (nonatomic, copy, readonly, nonnull) NSArray<id<TXAdImageTransformer>> *transformers;

- (nonnull instancetype)init NS_UNAVAILABLE;
+ (nonnull instancetype)new  NS_UNAVAILABLE;

+ (nonnull instancetype)transformerWithTransformers:(nonnull NSArray<id<TXAdImageTransformer>> *)transformers;
 ...
 */
@interface TXAdImageRoundCornerTransformer: NSObject <TXAdImageTransformer>
 ...
 */
@property (nonatomic, assign, readonly) TXAdRectCorner corners;
...
+ (nonnull instancetype)transformerWithRadius:(CGFloat)cornerRadius corners:(TXAdRectCorner)corners borderWidth:(CGFloat)borderWidth borderColor:(nullable UIColor *)borderColor;
 ...
 */
@interface TXAdImageResizingTransformer : NSObject <TXAdImageTransformer>
 ...
 */
@property (nonatomic, assign, readonly) TXAdImageScaleMode scaleMode;

- (nonnull instancetype)init NS_UNAVAILABLE;
+ (nonnull instancetype)new  NS_UNAVAILABLE;

+ (nonnull instancetype)transformerWithSize:(CGSize)size scaleMode:(TXAdImageScaleMode)scaleMode;
 ...
 */
@interface TXAdImageCroppingTransformer : NSObject <TXAdImageTransformer>
 ...
 */
@interface TXAdImageFlippingTransformer : NSObject <TXAdImageTransformer>
 ...
 */
@interface TXAdImageRotationTransformer : NSObject <TXAdImageTransformer>
 ...
 */
@interface TXAdImageTintTransformer : NSObject <TXAdImageTransformer>
 ...
 */
@interface TXAdImageBlurTransformer : NSObject <TXAdImageTransformer>
 ...
 */
@interface TXAdImageFilterTransformer: NSObject <TXAdImageTransformer>
